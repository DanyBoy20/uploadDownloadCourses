...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-12">
				<p class="text-justify">Si desea descargar alguno de nuestros cursos, debe <a href="iniciar.php">iniciar sesión.</a></p>
				<p class="text-justify">Si no tiene cuenta, debe <a href="registrar.html"> registrarse aquí.</a></p>
			</div>
		</div>
		<div class="row">
