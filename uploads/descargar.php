...
<body>
  ...
  <nav class="navbar sticky-top navbar-expand-lg navbar-dark colornv">
    <div class="container">
      ...
      <a class="navbar-brand" href="../usuarios/index.php"><img src="../img/LOGO_DH_BLANCO_NAV.svg" width="30" height="30" class="d-inline-block align-top" alt="logo">&nbsp;Cursos descargables online</a>
      <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        <ul class="navbar-nav mr-4 ml-4 mt-2 mt-lg-0 text-center">
          <li class="nav-item">
            <a class="nav-item nav-link active" href="../usuarios/index.php">Inicio Tablero</a>
          </li>
          <li class="nav-item">
            <a class="nav-item nav-link" href="../usuarios/cambiarcontra.php">Cambiar Contraseña</a>
          </li>
          <li class="nav-item">
            <a class="nav-item nav-link" href="../usuarios/logout.php">Cerrar Sesión</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12"><H1 class="display-4 my-4 text-center">LISTA DE CURSOS</H1></div>
    </div>
    <div class="row">
		...
		<div class="table-responsive">
			...
			<table class="table my-4 mx-2">
				<thead>
					...
					<th><p id="encabezadoparrafo">Opción</p></th>
				</thead>
				<tbody>
					<?php foreach ($archivos as $archivo): ?>
						<tr>
							...
							<td><a href="descargar.php?cvearchivo=<?php echo $archivo['id'] ?>"><p>Descargar</p></a></td>
						</tr>
					<?php endforeach;?>
				</tbody>
			</table>
