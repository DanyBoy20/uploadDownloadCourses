...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        <ul class="navbar-nav mr-4 ml-4 mt-2 mt-lg-0 text-center">
          ...
          <li class="nav-item">
            <a class="nav-item nav-link" href="cambiarcontra.php">Cambiar Contraseña</a>
          </li>
          <li class="nav-item">
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12"><H1 class="display-4 my-4 text-center">BIENVENIDO</H1></div>
    </div>
    <div class="row">
      ...
      <div class="col-sm-12 col-md-6">   
        <h4 class="titulos my-4">Cursos gratuitos descargables</h4>
        <p class="text-justify">Los cursos que ofrecemos son totalmente descargables y gratuitos. Creemos que el aprendizaje en la red debe ser libre para compartir.</p>
        <p class="text-justify">Para visualizar y descargar los cursos, ve nuestro menú de opciones.</p>
      </div>
    </div>
  </div>
